const githubData = [
  ...
  let index = githubData.findIndex(eachObject => eachObject.id === "8030403992");




  
                                        // this is what the function looks like when not in shorthand
//   let index = githubData.findIndex(function (eachObject) { eachObject.id === "8030403992"});
